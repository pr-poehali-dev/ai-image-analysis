        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:hello@videolearn.ru"
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Обучение</span>
                </div>
                <p className="text-base text-foreground md:text-2xl">Онлайн — везде и всегда</p>
              </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Какой предмет интересует?</label>
                <input
                  type="text"
                  value={formData.subject}
                  onChange={(e) => setFormData({ ...formData, subject: e.target.value })}
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Например: Python, английский, математика..."
                />
              </div>
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка отправлена! Свяжемся с вами в ближайшее время.</p>
                )}
              </div>
            </form>
          </div>
